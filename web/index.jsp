...
<head>
	<title>Edulearn Education Category Bootstrap Responsive Website Template | Home </title>
	<!-- Meta tag Keywords -->
...
<body>
	...
	<header>
		<!-- top header -->
		<div class="top-head-educationsls py-2 bg-dark">
			<div class="container">
				<div class="row">
					<h1 class="text-capitalize text-white col-7">
						<i class="fas fa-book text-dark bg-white p-2 rounded-circle mr-3"></i>welcome to Coder's Junction</h1>
					<!-- social icons -->
		...
		<div class="middle-educationsls-nav py-2">
			<div class="container">
				<div class="row">
                                    <a class="logo font-italic font-weight-bold col-lg-4 text-lg-left text-center" href="index.html"><small>Coder's Junction</small></a>
	...
	<!-- banner -->
	<!---<div class="banner-edulearn">
		<ul class="slider">
			<li class="active">
				<div class="banner-educationsls-1">
				</div>
			</li>
			<li>
				<div class="banner-educationsls-2">
				</div>
			</li>
			<li>
				<div class="banner-educationsls-3">
				</div>
			</li>
			<li>
				<div class="banner-educationsls-4">
				</div>
			</li>
			<li class="prev">
				<div class="banner-educationsls-5">
				</div>
			</li>
		</ul>
		<ul class="pager">
		...
		<div class="banner-text-posi-educationsls">
			<div class="banner-text-whtree">
				...
				<a href="about.html" class="button-edulearns text-capitalize text-white mt-sm-5 mt-4">read more</a>
			</div>
		</div>

		<!-- navigation -->
		<div class="navigation-educationsls">
	...
	<!-- Stats-->
	<!---<div class="stats-educationslayouts py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="stats-info">
				<div class="row">
					<div class="col-md-3 col-6 stats-grid-educations-edulearn text-center px-xl-5 px-3">
					...
					<div class="col-md-3 col-6 stats-grid-educations-edulearn text-center mt-md-0 mt-5  px-xl-5 px-3">
	...
	<div class="classes py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-sm-5 mb-4">choose a
...
String description=rs.getString("description");
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="view_questions_category_wise.jsp?category=<%=catname%>">
							<div class="img">
                                                            <img src="<%=photo%>" style="width:100%;height:100%;" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
								<h3 class="text-capitalize text-white"><%=catname%></h3>
								<p><%=description   %></p>
							</div>
						</a>
					</div>
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="view_questions_category_wise.jsp" class="text-dark"><%=catname%>
	...
	<!-- what we do -->
	<!---<div class="why-choose-edulearn py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-white text-center mb-5">what we
				<span class="font-weight-bold">do</span>
			</h3>
			<div class="row edulearnits-educationslayouts-grid pt-md-4">
				<div class="col-lg-4 services-edulearn-1">
					<div class="row learns_edulearn_us">
						<div class="col-lg-3 col-md-2 col-3  edulearn-why-text">
							<div class="learns_features_grid text-center p-3 border rounded">
								<i class="fab fa-accusoft"></i>
							</div>
						</div>
						<div class="col-9 edulearn-why-text-2">
				...
				<div class="col-lg-4 services-edulearn-1 my-lg-0 my-5">
					<div class="row learns_edulearn_us">
						<div class="col-lg-3 col-md-2 col-3  edulearn-why-text">
							<div class="learns_features_grid text-center p-3 border rounded">
			...
			<div class="row edulearnits-educationslayouts-grid mt-5">
				<div class="col-lg-4 services-edulearn-1">
					<div class="row learns_edulearn_us">
						<div class="col-lg-3 col-md-2 col-3  edulearn-why-text">
							<div class="learns_features_grid text-center p-3 border rounded">
	...
	<!-- video and events -->
	<div class="video-choose-edulearn py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="row">
	...
	<div class="news-section py-5">
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row news-grids-educationsl pt-md-4">
				<div class="col-md-4 news-grid">
					<a href="blog.html">
						<img src="images/n1.jpg" class="img-fluid" alt="" />
					</a>
					<div class="news-text">
						<div class="news-events-edulearn event-colo1 py-2 px-3">
							<h5 class="float-left">
				...
				<div class="col-md-4 news-grid my-md-0 my-sm-5 my-4">
					...
					<div class="news-text">
						<div class="news-events-edulearn py-2 px-3">
							<h5 class="float-left">
								<a href="blog.html" class="text-white">07 May</a>
							</h5>
							<div class="post-img float-right">
				...
				<div class="col-md-4 news-grid">
					...
					<div class="news-text">
						<div class="news-events-edulearn event-colo3 py-2 px-3">
							<h5 class="float-left">
								<a href="blog.html" class="text-white">07 May</a>
							</h5>
							<div class="post-img float-right">
	...
	<!-- brands -->
	<div class="brands-educationsls py-md-5 py-4">
	...
	<footer>
		<div class="container py-4">
			<div class="row py-xl-5 py-sm-3">
				...
				<div class="col-lg-6 contact-edulearnits-educationslayouts mt-lg-0 mt-4">
					...
					<div class="subscribe-educationsls my-xl-5 my-4">
					...
					<p class="para-edulearnits-educationslayouts text-white">
						<i class="fas fa-map-marker pr-3"></i>25095 Blue Ravine Rd,USA</p>
					<p class="para-edulearnits-educationslayouts text-white my-sm-3 my-2">
						<i class="fas fa-phone pr-3"></i>032 625 4592</p>
					<p class="para-edulearnits-educationslayouts">
		...
		<div class="copyright-edulearns py-3">
			<div class="container">
				<div class="row">
